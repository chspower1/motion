...
import { ContentContainer, ContentTitle, Box, RedirectBtn } from "../styled/SampleStyled";

export const myVars1 = {
    start: { scale: 0 },
    end: {
        scale: 1,
        rotateZ: 180,
...
export default function AnimationBox({ onClickRefresh, refresh }: AnimationBoxProps) {
    return (
